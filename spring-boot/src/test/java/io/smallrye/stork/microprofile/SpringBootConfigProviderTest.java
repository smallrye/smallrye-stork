...
public class SpringBootConfigProviderTest {
    ...
    @Test
    void shouldConfigureServiceRegistrar() throws IOException {
        ...
        ServiceRegistrar<TestServiceRegistrarProvider.TestMetadata> serviceRegistrar = stork.getService(MY_REGISTRAR)
                .getServiceRegistrar();
        assertThat(serviceRegistrar).isInstanceOf(TestServiceRegistrarProvider.TestServiceRegistrar.class);

        serviceRegistrar.registerServiceInstance("foo", Metadata.of(TestServiceRegistrarProvider.TestMetadata.class)
                .with(TestServiceRegistrarProvider.TestMetadata.FIRST, "1st"), "1.1.1.1", 8080)
        ...
        assertThat(registration.metadata.getMetadata().get(TestServiceRegistrarProvider.TestMetadata.FIRST)).isEqualTo("1st");
        assertThat(registration.serviceRegistrarName).isEqualTo(MY_REGISTRAR);
    ...
    private Stork storkForConfig(Map<String, String> props) {
        ...
        SpringBootApplicationContextProvider springBootApplicationContextProvider = new SpringBootApplicationContextProvider();
        springBootApplicationContextProvider.setApplicationContext(context);
