 ...
 * {@code stork.<my-service>.load-balancer.my-attribute}
 *
 * In the configuration class generated for the load balancer, this attribute will be exposed through {@code getMyAttribute()}
 */
