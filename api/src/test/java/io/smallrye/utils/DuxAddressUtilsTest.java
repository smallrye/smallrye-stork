...
public class DuxAddressUtilsTest {

    @Test
    void shouldParseIpv6WithoutPort() {
        String ipv6WithoutPort = "2001:0db8:85a3:0000:0000:8a2e:0370:7334";
        HostAndPort result = DuxAddressUtils.parseToHostAndPort(ipv6WithoutPort, 8080,
    ...
    void shouldParseIpv6WithSquareBracketsWithoutPort() {
        ...
        HostAndPort result = DuxAddressUtils.parseToHostAndPort(toParse, 8080,
    ...
    void shouldParseIpv6WithPort() {
        ...
        HostAndPort result = DuxAddressUtils.parseToHostAndPort(toParse, 8080, "serviceUsingSpecifiedPort");
        assertThat(result.host).isEqualTo(ipv6WithoutPort);
    ...
    void shouldParseIpV4WithoutPort() {
        ...
        HostAndPort result = DuxAddressUtils.parseToHostAndPort(ipV4WithoutPort, 8383, "serviceUsingIPv4AdressWithoutPort");
    ...
    void shouldParseIpV4WithPort() {
        ...
        HostAndPort result = DuxAddressUtils.parseToHostAndPort(addressWithPort, 8383, "serviceUsingIPv4AdressWithPort");
    ...
    void shouldParseHostnameWithoutPort() {
        ...
        HostAndPort result = DuxAddressUtils.parseToHostAndPort(address, 8383, "serviceUsingHostnameWithoutPort");
        assertThat(result.host).isEqualTo(address);
        assertThat(result.port).isEqualTo(8383);
    }
    ...
    void shoyuldParseHostnameWithPort() {
        ...
        HostAndPort result = DuxAddressUtils.parseToHostAndPort(addressWithPort, 8383, "serviceUsingHostnameWithPort");
        assertThat(result.host).isEqualTo(address);
