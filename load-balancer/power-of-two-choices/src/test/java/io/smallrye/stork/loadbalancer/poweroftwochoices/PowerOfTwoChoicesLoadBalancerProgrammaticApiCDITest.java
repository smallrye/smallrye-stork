...
public class PowerOfTwoChoicesLoadBalancerProgrammaticApiCDITest {
    private static final Logger log = LoggerFactory.getLogger(PowerOfTwoChoicesLoadBalancerProgrammaticApiCDITest.class);
